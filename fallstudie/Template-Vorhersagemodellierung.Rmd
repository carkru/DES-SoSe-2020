---
title: "Vorhersagemodellierung Fahrradvermietungen"
author: "Gabi Musterstudentin, Horst Vozeigestundent, Biene Maja"
date: "`r Sys.Date()`"
output: 
  word_document:
editor_options: 
...
```{r}
train <- read.csv2("../data/tipstrainingsdaten.csv")
anwendung <- read.csv2("../data/tipsanwendungsdaten.csv")
```
...
# Methodenbeschreibung^[Horst Vozeigestundent]
...
```{r}
inspect(lm.predict)
write.csv2(lm.predict, file = "../data/Prognose_IhrName.csv")
```
